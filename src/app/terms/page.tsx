          ...
          <div className="prose-cs space-y-8 text-cs-body">
            <div>
              <p className="text-sm leading-relaxed">
                ...
                or &ldquo;<strong>our</strong>&rdquo;). These Terms of Service
                (&ldquo;<strong>Terms</strong>&rdquo;) govern your access to and
                use of our website, services, and content. By using
                ComfySeniors.com, you agree to be bound by these Terms. If you
