      ...
      <section className="py-12 sm:py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 space-y-8 text-cs-body">
            {/* TODO (full LLC metadata): formation date, registered
                agent name + address, and NJ Business Registration
                Certificate (BRC) number are still pending from
                founder. Add them here once the filing certificate is
                in hand — ideally in a "Filed [DATE]. Registered
                agent: [NAME], [ADDRESS]. NJ BRC: [NUMBER]." sentence
                after the LLC identification below. */}
            <Section title="1. Who We Are">
              <p>
                ComfySeniors.com (&ldquo;<strong>ComfySeniors</strong>,&rdquo;
                &ldquo;<strong>we</strong>,&rdquo; &ldquo;<strong>us</strong>&rdquo;)
                is an independent senior care directory operated by{" "}
                <strong>ComfySeniors LLC</strong>, a New Jersey limited
                liability company. This Privacy Policy explains what
